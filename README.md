...
- 报分按聊天昵称匹配选手（与「查询」一致），支持指定 `setId` 补报
...
- 比分写作 `<报分选手局数>-<对手局数>`，**数字更大的一方自动为胜者**，无需再填「我/对手」
...
@机器人 报分 2-1          # 你 2 局、对手 1 局，你获胜
@机器人 报分 0-2          # 你 0 局、对手 2 局，对手获胜
@机器人 报分 gamera 2-0   # 管理员代报：gamera 2-0 获胜
@机器人 报分 2-1 12345678 # 对指定 setId 报分
# 成功回复示例：报分成功，胜者为PlayerName
```
